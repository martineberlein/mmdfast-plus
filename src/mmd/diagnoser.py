...
from mmd.rules.ruleset import generate_ruleset, RuleSet
from mmd.rules.rule import Rule
from mmd.rules.conjuncts import generate_conjuncts
from mmd.util import sorted_pareto_optimal_rules, partition, ConfusionMatrix, BinningMethod, debug_list_log, bold, percent_format
import mmd.rules.predicate as Predicates
import mmd.cfg as cfg
import mmd.timing as Timing
...
def discover(
	...
	if config is None:
		...
		config.disjunctions = allow_disjunctions
